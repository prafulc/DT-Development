          ...
          members.map(function(member){
            ...
            return(
              <div key={member._id}>
                ...
                {/*<ImageList member = {member} active = {that.props.activeUser}/>/
                
                <li key={member._id}>
                  <div className={that.props.activeUser == member._id ? "member-span active":"member-span"} data-id={member._id} onClick={that.startChat.bind(this)}>
                    {member.profile.name}
                  </div>
                </li>*/}
              </div>
